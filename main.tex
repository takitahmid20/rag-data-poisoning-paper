...
The presentation associated with this project also lists Phantom, RevPRAG, CorruptRAG, PIDP-Attack, RobustRAG, and TrustRAG as comparison targets. Their exact bibliographic records were not available in the project repository at the time of writing; they are therefore not assigned invented citations here. Before archival submission, the team should verify each title, author list, venue, year, and DOI/arXiv identifier and extend Table~\ref{tab:literature}. This is preferable to presenting an attractive but unverifiable reference list.
